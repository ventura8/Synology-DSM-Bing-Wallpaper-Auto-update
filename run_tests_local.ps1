...
if ($foundXmlPath) {
    ...
    docker run --rm `
        ...
        commandline --files /tmp/report/*/cobertura.xml --badge true --fail false --format markdown --hidebranch false --hidecomplexity true --indicators true --output console --thresholds '90 95'
