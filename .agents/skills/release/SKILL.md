...
exist (fails the workflow otherwise), and creates the GitHub Release with that
file as the body plus `bing_wallpaper_auto_update.sh` + a generated
`SHA256SUMS` as attached assets. The release notes file must be committed
